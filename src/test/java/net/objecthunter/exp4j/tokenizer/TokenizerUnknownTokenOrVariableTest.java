...
/**
 * This test is to check if {@link UnknownFunctionOrVariableException} generated when expression contains unknown function or variable
 * contains necessary expected details.
 *
...
public class TokenizerUnknownTokenOrVariableTest {
    ...
    public void testTokenizationOfUnknownVariable() {
        final var tokenizer = new Tokenizer("3 + x", null, null, null);
    ...
    public void testTokenizationOfUnknownVariable2Details() {
        ...
        final var tokenizer = new Tokenizer("x + 3", null, null, null);
    ...
    public void testTokenizationOfUnknownFunction() {
        final var tokenizer = new Tokenizer("3 + p(1)", null, null, null);
        while (tokenizer.hasNext()) {
            tokenizer.nextToken();
        }
    }
    ...
    public void testTokenizationOfUnknownFunction2Details() {
        ...
        final var tokenizer = new Tokenizer("p(1) + 3", null, null, null);
